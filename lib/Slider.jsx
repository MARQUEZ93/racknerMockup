...
class Slider extends React.Component {
  constructor(props) {
    ...
    this.arrowSVG = (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        ...
        <g><g> <path style={{fill:"white"}} d="M70.846,324.059c3.21,3.926,8.409,3.926,11.619,0l69.162-84.621c3.21-3.926,1.698-7.108-3.372-7.108h-36.723
    ...
    return (
      <div className="sliderRow" key={name}>
        ...
        <div className="bottomSliderRow">
          <input onChange={this.handleChange(name)} type="range" min={min} max={max} step={step} value={this.state[name]} className="slider" id="myRange" />
        </div>
      </div>
    );
  ...
  renderRows() {
    return ([this.sliderRow("Color Temp", "K", "2700", "4700", "200"), this.sliderRow("Red"),
